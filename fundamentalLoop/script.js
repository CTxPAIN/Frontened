...
//question 3 even digit counter 
// let num=prompt("enter the no").split(" ").map(Number);
// let result=[];
// let count=0;
...
//question 4 finding second largest 
...
//     }
// }
// console.log("second larget", secondMax);
